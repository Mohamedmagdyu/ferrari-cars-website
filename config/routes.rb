...
Rails.application.routes.draw do
  # Routes for ferrari_cars generated by controller generator
  resources :ferrari_cars, only: [:index, :show]
  # End routes for ferrari_cars
