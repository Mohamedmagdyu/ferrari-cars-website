...
ActiveRecord::Schema[7.2].define(version: 2025_11_22_124702) do
  ...
  create_table "ferrari_cars", force: :cascade do |t|
    t.string "name"
    t.string "model"
    t.integer "year"
    t.decimal "price"
    ...
    t.index ["category_id"], name: "index_ferrari_cars_on_category_id"
    t.index ["slug"], name: "index_ferrari_cars_on_slug", unique: true
  end
  ...
  add_foreign_key "ferrari_cars", "categories"
end
